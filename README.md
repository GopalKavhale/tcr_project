...
Library Package Used : Numpy, Pandas, seaborn, Sklearn

Attribute Information: Input variables:

Bank client data:
1 - age (numeric)
2 - job : type of job (categorical: 'admin.','blue-collar','entrepreneur','housemaid','management','retired','self-employed','services','student','t echnician','unemployed','unknown')
...
16 - Has the client subscribed to a term deposit? (binary: 'yes','no') – Target Variable
